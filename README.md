...
- SharePoint & Enterprise Collaboration Platforms
...
A multi-organization performance evaluation platform featuring role-based access control, workflow approvals, multi-tenant architecture, reporting dashboards, and analytics.
...
**Technologies:** .NET MAUI, C#, ZXing.Net.MAUI
...
### Backend
ASP.NET Core, ASP.NET MVC, C#, Python, Django, Odoo
...
### Data & BI
Power BI, DAX, Excel, Reporting Solutions

### Platforms
SharePoint, Project Server (PWA), Odoo ERP
...
📫 Open to international opportunities, enterprise software projects, and technology collaborations.
